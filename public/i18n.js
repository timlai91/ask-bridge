...
(function () {
  ...
  const D = {
    "zh-TW": {
      ...
      "features.f3.t": "圖片與文件附件", "features.f3.d": "--image 與 --file 支援多 provider；Windows experimental M365 支援 PNG／JPEG 與 PDF／DOCX／TXT。",
    ...
    "en": {
      ...
      "features.f3.t": "Image & file attachments", "features.f3.d": "Use --image and --file across providers; Windows experimental M365 supports PNG/JPEG and PDF/DOCX/TXT.",
